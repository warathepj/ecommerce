  ...
  = ({ children }) => {
    ...
    const [products, setProducts] = useState([
      ...
      { id: "3", name: "ลำโพงบลูทูธ", 
        ...
        description: "ดื่มด่ำไปกับเสียงที่เต็มอิ่มจากขุมพลังขนาดพกพา, BeatBuddy มอบคุณภาพเสียงที่ยอดเยี่ยม เหมาะสำหรับการผจญภัยระหว่างเดินทาง",
      },
      { id: "4", name: "กระเป๋าสะพาย", 
        descriptionHead: "คว้าการผจญภัยของคุณ!",
        price: 10000, discount: 5,
        stock: 5,
        color: ["เทา", "น้ำตาล", "เขียว"], 
        image: "https://plus.unsplash.com/premium_photo-1664298317818-1f7c13bf6488?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        description: "ช้อปตอนนี้และรับส่วนลด 15% สำหรับการซื้อกระเป๋าเป้ครั้งต่อไปของคุณ"
      },
      { id: "5", name: "โทรศัพท์มือถือ", 
        descriptionHead: "T900-Tello",
        price: 13000, discount: 3,
        stock: 10,
        color: ["ดำ", "ขาว", "ฟ้า"], 
        image: "https://images.unsplash.com/photo-1598327106026-d9521da673d1?q=80&w=1527&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        description: "สัมผัสประสบการณ์แห่งอนาคตของเทคโนโลยีมือถือด้วย T900-Tello, อุปกรณ์ที่เพรียวบางและทรงพลังนี้มีหน้าจอ 6นิ้ว หน้าจอ Dynamic AMOLED ที่สวยงาม ให้สีสันสดใสและภาพคมชัด"
      },
      { id: "6", name: "NovaZen NZ500", 
        descriptionHead: "แล็ปท็อปประสิทธิภาพสูงสำหรับผู้ใช้ระดับสูงและมืออาชีพ",
        price: 33000, discount: 5,
        stock: 17,
        color: ["ดำ", "ขาว", "ฟ้า"], 
        image: "https://images.unsplash.com/photo-1511385348-a52b4a160dc2?q=80&w=1507&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        description: "Processor: Zintel Core z7 12th Gen, RAM: 16GB, Storage: 512GB SSD,Display: 15.6-inch Full HD, Operating System: Doors 11, Graphics: กราฟิก Zintel® ในตัว, Other features: webcam / microphone",
      }
    ]);
